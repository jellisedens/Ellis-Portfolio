...
const defaultSettings: SiteSettings = {
  ...
  websiteUrl: "",
  colorPrimary: "#2b7cb3",
  colorPrimaryDark: "#1e6a9e",
  colorPrimaryLight: "#9aceeb",
  colorAccent: "#9aceeb",
  colorCharcoal: "#4d4f48",
  colorCharcoalLight: "#595a54",
  colorBackground: "#f6f4f7",
  colorSurface: "#ffffff",
  colorSurfaceAlt: "#efeeef",
  colorText: "#4d4f48",
  colorTextMuted: "#595a54",
  colorTextLight: "#8a8b86",
  colorTextInverse: "#f6f4f7",
