      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {featured.map((project) => (
            <div key={project._id} className="bg-surface rounded-lg border border-border overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-text text-sm mb-4">{project.summary}</p>
        ...
        <div className="text-center mt-10">
          <Link to="/projects" className="inline-block bg-primary text-text-inverse px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors text-sm font-medium">
            View All Projects
          </Link>
        </div>
      </div>
